...
Theorem rev_snoc : forall (t:natlist) (h:nat),
...
(** Design exercise: 
     - Write down a non-trivial theorem involving [cons]
       ([::]), [snoc], and [app] ([++]).  
     - Prove it. *) 
Theorem snoc_app_cons : forall (l:natlist) (n:nat),
  (snoc l n) ++ l ++ [n] = (l ++ [n]) ++ l ++ [n].
Proof. 
  intros. 
  induction l as [|h' t'].
    simpl. reflexivity.
