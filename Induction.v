...
Proof.
  ...
  Case "n = C n'". simpl. rewrite <- IHn'. reflexivity. 
Qed. 
...
(* 
   Induction generates the Induction hypothesis whereas destruct does not
 *)
...
Theorem mult_plus_1 : forall m n': nat, 
 m * S n' = m * n' + m.
Proof.
  intros. 
  induction m as [|m'].
...
Proof.
  ...
  Case "n = C n'". simpl. 
    rewrite -> mult_plus_1. rewrite -> IHn'. rewrite -> plus_comm.
    reflexivity. 
Qed.
(** [] *)
...
Theorem neg_negb : forall n : bool, negb (negb n) = n.
Proof. 
  intros. 
  destruct n. 
    reflexivity. 
...
Proof.
  ...
  Case "p = C p'". simpl. rewrite -> IHp'. reflexivity. 
Qed.  
...
Proof.
  ...
  destruct n as [|n'].
  Case "n = 0". reflexivity.
  Case "n = C n'". simpl. rewrite -> plus_0_r. 
    reflexivity. 
Qed. 
...
(** Theorem: Addition is commutative.
    ...
    - First, Suppose [n = 0]. We must show
        0 + m = m + 0 
      apply plus_0_r Theorem, this comes to: 
        0 + m = 0 + m
      This follows directly the definition of [+].
    - Second, Suppose [n = S n'], where
      ...
      By the definition of [+], this follows from; 
        S (n' + m) = m + (S n')
      Apply Theorem plus_n_Sm from right to left, this follows from: 
        S (n' + m) = S (m + n')
      which is immediate from the induction hypothesis. 
...
(** Write an informal proof of the following theorem, using the
    ...
    Proof: 
      ...
      - First, suppose [n = 0]. We must show, 
          true = beq_nat 0 0 
        this comes directly from the definition of beq_nat.
      - Second, suppose [n = S n'], where
          true = beq_nat n' n'
        we must show, 
          true = beq_nat (S n') (S n')
        by the definiion of beq_nat, this follows from: 
          true = beq_nat n' n'
        which is immediate from induction hypothesis. 
[]
 *)
