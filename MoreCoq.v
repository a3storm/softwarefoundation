...
Proof.
  intros n.
  induction n as [|n'].
  destruct m. reflexivity. intros. simpl in H. inversion H.
  intros.  
  destruct m.  inversion H. simpl in H. apply IHn' in H. 
...
Proof.
  ...
  Case "l = []". 
    intros n eq. rewrite <- eq. simpl. reflexivity.
...
Proof. 
  ...
  Case "l = cons". simpl. 
    ...
    SCase "n = S n'". apply IHt. simpl. inversion H. 
    reflexivity. 
Qed. 
(** [] *)
...
Proof.
  ...
  destruct (beq_nat k1 k2) eqn: H1. 
    apply beq_nat_true in H1. rewrite H1 in H. symmetry. apply H.
  reflexivity. 
Qed. 
(** [] *)
...
Proof.
  ...
  destruct (beq_nat k1 k3) eqn: H1. 
    ...
    destruct (beq_nat k2 k3) eqn: H2.
      apply beq_nat_true in H2. rewrite H1 in H. rewrite H2 in H. rewrite <- beq_nat_refl in H. inversion H. 
      reflexivity. 
    destruct (beq_nat k2 k3) eqn: H2. 
      reflexivity. 
      reflexivity. 
