...
Fixpoint bin_to_nat (b : bin) : nat :=
  match b with 
    ...
    | Tand1 b' => S (mult 2 (bin_to_nat b'))
  end.

(** c *)
Example incb1 : incb (T ( T ( Tand1 Z))) = Tand1(T ( Tand1 Z)).
Proof. simpl. reflexivity. Qed.

Example incb2 : incb (T (Tand1 (T (Tand1 Z)))) = Tand1( Tand1 (T (Tand1 Z))).
Proof. simpl. reflexivity. Qed.

Example bin_to_nat1 : bin_to_nat (T ( T ( Tand1 Z))) = 4.
Proof. simpl. reflexivity. Qed.

Example bin_to_nat2 : bin_to_nat (Tand1(T ( Tand1 Z))) = 5.
Proof. simpl. reflexivity. Qed.

Example bin_to_nat3 : bin_to_nat ((T (Tand1 (T (Tand1 Z))))) = 10.
Proof. simpl. reflexivity. Qed.

Example bin_to_nat4 : bin_to_nat (Tand1( Tand1 (T (Tand1 Z)))) = 11.
Proof. simpl. reflexivity. Qed.
(* ###################################################################### *)
(** * Optional Material *)
