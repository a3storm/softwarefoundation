...
Proof. 
  intros. 
  unfold not.
  intros. inversion H0. apply H1 in H.
  apply H. 
Qed. 
(** [] *)
...
Proof.
  intros. 
  unfold override'.
  destruct (eq_nat_dec). reflexivity. reflexivity. 
Qed. 
(** [] *)
...
Inductive nostutter:  list nat -> Prop :=
 ...
 | nostutter_one : forall x, nostutter (x :: nil)
 | nostutter_cons : forall x y xs, x<>y -> nostutter (x :: xs) -> nostutter(y::x::xs)
.
